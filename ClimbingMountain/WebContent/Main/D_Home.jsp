			...
			<section id="mainVisual" class="section active">
					...
					<div class="main-visual-item" data-title="무등산" data-en-title="M.M1">
						...
						<div class="main-visual-txt-con">
							<div class="main-visual-txt-inner area-box">
								<strong class="main-visual-txt1 title-line"><span>무등산. 광주의 자태.<br>산의 아름다움에
										대하여.</span></strong>
								<p class="main-visual-txt2 title-line"><span>'끝없는 자연과 인간의 교감'</span></p>
							</div>
						</div>
					</div>
					<div class="main-visual-item" data-title="무등산2" data-en-title="M.M2">
						<div class="main-visual-pc-img"
							style="background:#fff url(images/Main_pic_02.jpg) no-repeat 50% 50%;"></div>
						<div class="main-visual-txt-con">
							<div class="main-visual-txt-inner area-box">
								<strong class="main-visual-txt1 title-line"><span>눈 내린 무등산. 겨울의 美.<br>산 타 클로스와
										함께.</span></strong>
							</div>
						</div>
					</div>
					<div class="main-visual-item" data-title="한국의 산1" data-en-title="K.M1">
						<div class="main-visual-pc-img"
							style="background:#fff url(images/Main_pic_04.jpg) no-repeat 70% 50%;"></div>
						<div class="main-visual-txt-con">
							<div class="main-visual-txt-inner area-box">
								<strong class="main-visual-txt1 title-line"><span>단풍.<br>붉은 고귀함.<br>자연을 느끼는
										자유.</span></strong>
							</div>
						</div>
					</div>
					<div class="main-visual-item" data-title="한국의 산2" data-en-title="K.M2">
						<div class="main-visual-pc-img"
							style="background:#fff url(images/Main_pic_05.jpg) no-repeat 60% 50%;"></div>
						<div class="main-visual-txt-con">
							<div class="main-visual-txt-inner area-box">
								<strong class="main-visual-txt1 title-line"><span>대한민국 등산 명소.</span></strong>
								<p class="main-visual-txt2 title-line"><span>산 타 클로스에서 아름다움을 만끽하세요.</span></p>
							</div>
						</div>
					</div>
				</div>
				...
				<aside class="main-visual-controls">
					...
					<div class="arrow-controls">
						<button class="prev-visual-btn" title="Prev"><i class="xi-angle-left"></i></button>
						<span class="paging-controls">
							<span class="cur">1</span> <em>/</em> <span class="total"></span>
						</span>
						<button class="next-visual-btn" title="Next"><i class="xi-angle-right"></i></button>
					</div>

					<div class="stop-pause-controls">
						<button class="pause-visual-btn"></button>
						<button class="play-visual-btn"><i class="xi-play"></i></button>
					</div>
				</aside>
			</section>
			<!-- 까지 1페이지 -->
			...
			<section id="mainNewsCon" class="section"
				...
				<div class="main-news-wrapper">
					<aside class="main-news-tit-box">
						<h3 class="main-news-tit main-txt-up"><span>광주 / 전남 13대명산</span></h3>
						<p class="main-news-sub-txt main-txt-up"><span>등산은 자연과 함께하는 호흡과 같습니다. 여러분의 등삶이 항상 산 타 클로스와 함께
								행복하길.</span></p>
					</aside>
					...
					<aside class="main-news-controls">
						...
						<div class="arrow-controls">
							<button class="prev-news-btn" title="Prev"><i class="xi-angle-left"></i></button>
							<span class="paging-controls">
								<span class="cur">1</span> <em>/</em> <span class="total"></span>
							</span>
							<button class="next-news-btn" title="Next"><i class="xi-angle-right"></i></button>
						</div>

						<div class="stop-pause-controls">
							<button class="pause-news-btn"></button>
							<button class="play-news-btn"><i class="xi-play"></i></button>
						</div>
					</aside>
				</div>
			</section>
					...
					<div id="footerInner" class="clearfix">
						...
						<article id="footerTop">
							...
							<article class="footer-left-con">
								<a href="D_Home.html">
									<div class="footer-logo"><img src="./images/logo_font.png" width="320px"
											height="160px"></div>
								</a>
							</article>
							<!-- 푸터 하단 중앙 -->
